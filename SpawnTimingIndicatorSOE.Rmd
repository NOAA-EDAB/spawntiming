...
p <- ggplot2::ggplot(annual |> dplyr::filter(Stage %in% c("Developing")), 
...
```
```{r}
p <- ggplot2::ggplot(annual |> dplyr::filter(Stage %in% c("Resting")), 
                     ggplot2::aes(x=Time, y=Value, color = Stage)) + # , colour = Stage
  ggplot2::geom_point() +
  #ggplot2::geom_line() +
  ecodata::geom_gls() +
...
```
```{r}
p <- ggplot2::ggplot(annual |> dplyr::filter(Stage %in% c("Ripe")), 
                     ggplot2::aes(x=Time, y=Value, color = Stage)) + # , colour = Stage
  ggplot2::geom_point() +
  #ggplot2::geom_line() +
  ecodata::geom_gls() +
...
```{r}
p <- ggplot2::ggplot(annual |> dplyr::filter(Stage %in% c("Spent")), 
                     ggplot2::aes(x=Time, y=Value, color = Stage)) + # , colour = Stage
  ggplot2::geom_point() +
  #ggplot2::geom_line() +
  ecodata::geom_gls() +
